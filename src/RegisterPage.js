                    ...
                    <div className="">
                        <form onSubmit={handleSubmit} noValidate>
                          <div className="row gx-3">
                            ...
                            {/* Desired Job Type */}
                            <div className="col-md-6 mb-3">
                              <label htmlFor="desired_job_type" className="form-label">
                            ...
                            {/* Preferred Shift */}
                            <div className="col-md-6 mb-3">
                              <label htmlFor="preferred_shift" className="form-label">
                            ...
                            <div className="col-md-6 mb-3">
                              <label htmlFor="preferred_work_location" className="form-label">
                            ...
                            <div className="col-md-6 mb-3">
                              <label htmlFor="cv" className="form-label">
                                CV (PDF, DOC, DOCX) <span className="text-muted">(Optional)</span>
                              </label>
                              <input
                                type="file"
                            ...
                            <div className="col-md-12 mb-3">
                              ...
                              <input
                                type="number" // Changed to numeric input
